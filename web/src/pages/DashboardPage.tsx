...
export function DashboardPage() {
  ...
  const formattedData = data.map((d) => ({
    ...d,
    date: format(parseISO(d.date), days > 7 ? "MMM dd" : "E dd"),
  }));
  ...
  return (
    <div className="space-y-8">
          ...
          <Button
            ...
            className={`btn-ghost px-3 py-1 rounded ${
              days === opt
                ...
                : "bg-surface-light dark:bg-border-dark"
            }`}
          >
            Last {opt} Days
          </Button>
      ...
      <div className="card">
        <div className="card-header">
          <h2 className="font-semibold text-lg dark:text-text-light">
            Body Weight Trend (Last {days} Days)
          </h2>
        </div>
        <div className="card-body h-80">
          {loading ? (
